...
5. Do not use generic or repetitive phrases across the 3 variations.
6. Ensure each variation is unique in its approach (e.g., one short and punchy, one detailed and grateful, one focusing on a specific detail from the review).
7. If the platform is 'gbp' (Google Business Profile), keep SEO keywords in mind without overstuffing.
