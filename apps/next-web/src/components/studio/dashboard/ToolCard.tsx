            ...
            <CardContent sx={{ flexGrow: 1, display: 'flex', flexDirection: 'column' }}>
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 2 }}>
                    ...
                    <Box sx={{ display: 'flex', gap: 1 }}>
                        {isNew && <Chip label={t('common.common.new')} size="small" sx={{ bgcolor: '#FF4081', color: 'white', borderRadius: 1, height: 22, fontSize: '0.7rem', fontWeight: 'bold' }} />}
                        {isPopular && <Chip label={t('common.common.popular')} size="small" sx={{ bgcolor: '#7C4DFF', color: 'white', borderRadius: 1, height: 22, fontSize: '0.7rem', fontWeight: 'bold' }} />}
                    </Box>
                </Box>
